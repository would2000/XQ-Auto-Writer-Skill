...
選股中心、每日清單、排行、因子分析、回溯、回測與錯誤碼的官方文章蒸餾另見 [screener-learning-guide.md](screener-learning-guide.md)。該文件跨越 2016–2025 年，屬文件證據；入口、控制項、限制及資料行為若與本頁的 XQ 3.19.03 實測不同，必須保留差異並以目前 XQ 重新讀回，不得使用舊圖座標。
